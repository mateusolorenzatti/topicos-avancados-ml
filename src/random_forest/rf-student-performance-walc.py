...
Levantamento do Consumo de Álcool em fins de semana por estudante
...
def floresta_randomica(X_train,X_test,y_train, y_test):
    ...
    from sklearn.metrics import confusion_matrix
    from sklearn.metrics import accuracy_score
    floresta = RandomForestClassifier(n_estimators=25, max_features=10, criterion='gini', random_state=1)
